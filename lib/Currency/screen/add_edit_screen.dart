...
import 'package:mobile_pos/Extension/dynamic_icon_currency.dart';
import 'package:mobile_pos/Widget/Currency/model/currency_mode.dart';
import 'package:mobile_pos/Widget/Currency/provider/currency_provider.dart';
import 'package:mobile_pos/Widget/CustomWidget/button/appbar_button.dart';
import 'package:mobile_pos/Widget/CustomWidget/button/submit_button.dart';
import 'package:mobile_pos/Widget/CustomWidget/input_formatter.dart';
import 'package:mobile_pos/Widget/CustomWidget/nodata_widget.dart';
import 'package:mobile_pos/Widget/CustomWidget/text_field/input_text_filed_widget.dart';
import 'package:mobile_pos/Widget/Style/PopupDialog.dart';
import 'package:mobile_pos/Widget/Style/StyleColor.dart';
                ...
                children: [
                  Container(
                    ...
                    child: (selectedCurrencyCode?.isNotEmpty == true || widget.data?.dataCode?.isNotEmpty == true)
                        ? Text(
                            CurrencyExtention.currencyIconSecond(
                              currencyCode: selectedCurrencyCode ?? widget.data?.dataCode,
                            ),
                            style: StyleColor.textStyleKhmerContentBlack.copyWith(
