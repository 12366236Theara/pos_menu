...
import 'package:mobile_pos/Widget/Currency/screen/add_edit_screen.dart';
import 'package:mobile_pos/Widget/Currency/widget/render_card.dart';
...
import 'package:mobile_pos/Widget/CustomWidget/text_field/active_combobox.dart';
import 'package:mobile_pos/Widget/CustomWidget/text_field/search_text_filed.dart';
              ...
              CreateButtonWidget(
                onCreate: () async {
                  await Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const AddEditCurrencyScreen(),
                    ),
                  );
                },
              )
                ...
                child: Row(
                  children: [
                    SearchTextFieldWidget(
                      hintText: 'label.ស្វែងរក ​រូបិយវត្ថុ'.tr(),
                    ),
